...
my_lunch = [("Творог нежирный", 150), ("Картофель вареный", 200), ("Курица", 100)]
my_lunch1 = [("Творог нежирный", 150), ("Картофель вареный", 200), ("Курица", 100), ("Гречка", 100)]
my_lunch2 = [("Творог нежирный", 150), ("Картофель вареный", 200), ("Курица", 100), ("Гречка", 100), ("Манка", 100)]


result = calc_nutrient(my_lunch)
result1 = calc_nutrient(my_lunch1)
result2 = calc_nutrient(my_lunch2)

# print(f"Калорийность продуктов - {calc_nutrient(my_lunch1)} ккал")
print(f"Каллорийность продуктов - {result[3]} ккал"
